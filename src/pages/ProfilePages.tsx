            ...
            <section className="relative py-8">
              <div className="px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                  ...
                  >
                    <UserCircle className="h-16 w-16 text-purple-300/60 mx-auto mb-6" />
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                      <Link 
                        to="/giris-yap" 
                        className="inline-flex items-center justify-center px-6 py-3 font-bold text-black rounded-xl bg-gradient-to-r from-purple-400 via-purple-300 to-purple-400 shadow-[0_0_30px_rgba(139,92,246,0.5)] hover:shadow-[0_0_50px_rgba(139,92,246,0.7)] transition-all"
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onFocus={(e) => {
                          ...
                          e.currentTarget.style.boxShadow = '0 0 0 4px rgba(139, 92, 246, 0.1), inset 0 2px 4px rgba(0,0,0,0.2)';
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = '0 12px 40px rgba(139,92,246,0.15), 0 4px 16px rgba(0,0,0,0.3)';
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      <div 
        ...
        style={{
          background: 'linear-gradient(90deg, rgba(168, 85, 247, 0.6), rgba(139, 92, 246, 0.3), transparent)',
        }}
      />

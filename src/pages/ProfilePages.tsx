          ...
          <div className="w-full relative z-10">
            ...
            <section className="relative py-8">
              <div className="px-4 sm:px-6 lg:px-8">
                ...
                >
                  <UserCircle className="h-16 w-16 text-amber-400/60 mx-auto mb-6" />
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <Link 
                      to="/giris-yap" 
                      className="inline-flex items-center justify-center px-6 py-3 font-bold text-black rounded-xl bg-gradient-to-r from-amber-400 via-amber-300 to-yellow-400 shadow-[0_0_30px_rgba(251,191,36,0.5)] hover:shadow-[0_0_50px_rgba(251,191,36,0.7)] transition-all"
                    >
                    ...
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        onFocus={(e) => {
                          ...
                          e.currentTarget.style.boxShadow = '0 0 0 4px rgba(251, 191, 36, 0.1), inset 0 2px 4px rgba(0,0,0,0.2)';
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <button
                        ...
                        className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-amber-400 transition-all duration-200 p-1.5 rounded-lg hover:bg-amber-400/10"
                      >
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.boxShadow = '0 12px 40px rgba(251,191,36,0.15), 0 4px 16px rgba(0,0,0,0.3)';
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      <div 
        ...
        style={{
          background: 'linear-gradient(90deg, rgba(251, 191, 36, 0.6), rgba(251, 191, 36, 0.3), transparent)',
        }}
      />
      ...
      <div className="p-6 sm:p-7 flex flex-col h-full">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div 
                ...
                style={{
                  ...
                  boxShadow: '0 4px 8px rgba(251, 191, 36, 0.15)',
                }}
              >
        ...
        <form onSubmit={onSubmit} className="flex-1 flex flex-col space-y-5">
          ...
          <motion.button
            ...
            onMouseEnter={(e) => {
              if (!updating) {
                e.currentTarget.style.boxShadow = '0 12px 32px rgba(251,191,36,0.5), inset 0 1px 0 rgba(255,255,255,0.4)';
              }
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.boxShadow = '0 8px 24px rgba(251,191,36,0.4), inset 0 1px 0 rgba(255,255,255,0.3)';
            }}
          >

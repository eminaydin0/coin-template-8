                ...
                <div className="max-w-7xl mx-auto">
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                      <Link to="/giris-yap">
                        <motion.button
                          className="font-bold text-black py-3 px-6 rounded-xl transition-all duration-300 bg-gradient-to-r from-purple-400 via-purple-300 to-purple-400 shadow-[0_0_30px_rgba(139,92,246,0.5)] hover:shadow-[0_0_50px_rgba(139,92,246,0.7)]"
              ...
              <div className="max-w-7xl mx-auto">
                {orders.length === 0 ? (
                  ...
                  >
                    ...
                    <Link to="/oyunlar">
                      <motion.button
                        className="font-bold text-black py-3 px-6 rounded-xl transition-all duration-300 bg-gradient-to-r from-purple-400 via-purple-300 to-purple-400 shadow-[0_0_30px_rgba(139,92,246,0.5)] hover:shadow-[0_0_50px_rgba(139,92,246,0.7)] inline-flex items-center gap-2"
                        whileHover={{ scale: 1.05, y: -2 }}
                        whileTap={{ scale: 0.98 }}
                      >
          ...
          <div className="mt-2 pt-2 border-t" style={{ borderColor: 'rgba(75,85,99,0.2)' }}>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1">
                <span className="text-[10px] font-semibold text-purple-300">Görüntüle</span>
                <motion.div
                  whileHover={{ x: 2 }}

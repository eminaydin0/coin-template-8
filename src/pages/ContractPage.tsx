              ...
              <div className="rounded-2xl backdrop-blur-xl bg-black/20 border border-white/10 p-6 shadow-2xl">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <FileTextIcon className="h-4 w-4 text-purple-300" />
                    </div>
          ...
          <section className="relative py-8">
            <div className="px-4 sm:px-6 lg:px-8">
              <div className="max-w-7xl mx-auto">
                ...
                >
                  <FileTextIcon className="h-16 w-16 text-purple-300/60 mx-auto mb-6" />
                  ...
                  <Link 
                    to="/" 
                    className="inline-flex items-center gap-2 px-6 py-3 font-bold text-black rounded-xl bg-gradient-to-r from-purple-400 via-purple-300 to-purple-400 shadow-[0_0_30px_rgba(139,92,246,0.5)] hover:shadow-[0_0_50px_rgba(139,92,246,0.7)] transition-all"
                  >
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                <div className="p-6 sm:p-8">
                  {/* Contract Header */}
                  <div className="flex items-center gap-4 mb-6 pb-6 border-b" style={{ borderColor: 'rgba(168, 85, 247, 0.2)' }}>
                    <div 

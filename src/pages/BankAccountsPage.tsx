            ...
            <div className="rounded-2xl backdrop-blur-xl bg-black/20 border border-white/10 p-6 shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-center gap-2">
                  ...
                  >
                    <CreditCardIcon className="h-4 w-4 text-purple-300" />
                  </div>
          ...
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              {bankAccounts.length === 0 ? (
                ...
                >
                  <CreditCardIcon className="h-16 w-16 text-purple-300/60 mx-auto mb-6" />
      ...
      >
        ...
        <div className="p-3 relative z-0 flex flex-col h-full">
          ...
          <div className="flex-1 flex flex-col space-y-2">
            ...
            >
              <p className="text-purple-300/90 text-[10px] font-mono text-center break-all">
                {account.iban}
              </p>
            </div>
            ...
            <motion.button
              ...
              className={`w-full font-bold py-2.5 px-3 rounded-xl transition-all duration-300 flex items-center justify-center gap-1.5 mt-auto text-xs ${
                isCopied 
                  ...
                  : 'bg-gradient-to-r from-purple-400 via-purple-300 to-purple-400 text-black shadow-[0_0_30px_rgba(139,92,246,0.5)] hover:shadow-[0_0_50px_rgba(139,92,246,0.7)]'
              }`}

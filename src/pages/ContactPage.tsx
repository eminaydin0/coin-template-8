          ...
          <div className="px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
              {(!contactPhone && !contactEmail && !contactAddress) ? (
                ...
                >
                  <Headphones className="h-16 w-16 text-purple-300/50 mx-auto mb-6" />
          ...
          <div className="flex-1 flex flex-col space-y-2">
            ...
            <div className="mt-auto pt-2 border-t" style={{ borderColor: 'rgba(75,85,99,0.2)' }}>
              ...
              >
                ...
                <div className="flex items-center gap-1.5">
                  <span className="text-[10px] font-semibold text-purple-300">İletişim</span>
                  <ButtonIcon className="h-3.5 w-3.5 text-purple-300" />
                </div>
              </motion.div>
            </div>
          </div>
